...
const getComments = async (post_id) => {
  ...
  const query = `SELECT comments.id,username,first_name, last_name, to_char(comments.created_at  ,'Mon dd ''yy HH:MI AM') AS created_at, avatar, comments.content FROM comments 
